...
export const CAPABILITIES: CapabilityRecord[] = [
  // ---- Fabric core ----
  cap({ id: "fabric.workspace.browse", provider: "fabric", nativeItemType: "workspace", operation: "browse", authoringMode: "vscode-extension",
  ...
  cap({ id: "fabric.workspace.capture-summary", provider: "fabric", nativeItemType: "workspace", operation: "capture-summary", authoringMode: "cli",
  ...
  cap({ id: "fabric.notebook.edit-local-sync", provider: "fabric", nativeItemType: "notebook", operation: "edit-and-run", authoringMode: "local-sync",
    ...
    requirements: [
      ...
      { anyOf: ["cli.copilot", "ws.mcp"], need: "optional", why: "AI helpers; a manual notebook workflow does not need them." }],
  ...
  cap({ id: "fabric.notebook.edit-remote-vfs", provider: "fabric", nativeItemType: "notebook", operation: "edit-and-run", authoringMode: "remote-vfs",
  ...
  cap({ id: "fabric.items.deploy", provider: "fabric", nativeItemType: "workspace-items", operation: "deploy", authoringMode: "cli",
  ...
  // ---- Fabric RTI ----
  cap({ id: "fabric.eventstream.deploy", provider: "fabric", nativeItemType: "eventstream", operation: "deploy", authoringMode: "git-or-deployment-pipeline",
  ...
  // ---- Airflow ----
  cap({ id: "airflow.fabric-job.git-sync", provider: "airflow", nativeItemType: "apache-airflow-job", operation: "sync-dags", authoringMode: "fabric-git-sync",
  ...
  // ---- Databricks ----
  cap({ id: "databricks.bundle.validate", provider: "databricks", nativeItemType: "asset-bundle", operation: "validate", authoringMode: "cli",
  ...
  cap({ id: "databricks.bundle.deploy", provider: "databricks", nativeItemType: "asset-bundle", operation: "deploy", authoringMode: "cli",
  ...
  cap({ id: "databricks.notebook.connect", provider: "databricks", nativeItemType: "notebook", operation: "develop", authoringMode: "databricks-connect",
  ...
  cap({ id: "powerbi.semantic-model.edit-tmdl", provider: "powerbi", nativeItemType: "semantic-model", operation: "edit", authoringMode: "tmdl-text",
    ...
    requirements: [{ anyOf: ["ext.tmdl"], need: "optional", why: "Language support and diagnostics; plain text editing works without it." },
      ...
      { anyOf: ["cli.copilot", "ws.mcp"], need: "optional", why: "AI helpers are never prerequisites for manual editing." }],
  ...
  cap({ id: "powerbi.report.edit-pbir", provider: "powerbi", nativeItemType: "report", operation: "edit", authoringMode: "pbir-json",
  ...
  cap({ id: "powerbi.project.open-desktop", provider: "powerbi", nativeItemType: "pbip", operation: "open", authoringMode: "desktop",
  ...
  // ---- Grafana ----
  cap({ id: "grafana.dashboards.git-sync", provider: "grafana", nativeItemType: "dashboard", operation: "sync", authoringMode: "git-sync",
  ...
  cap({ id: "grafana.datasources.configure", provider: "grafana", nativeItemType: "datasource", operation: "configure", authoringMode: "gcx-or-iac",
  ...
  // ---- Infrastructure ----
  cap({ id: "infra.tofu.plan", provider: "infrastructure", nativeItemType: "infrastructure-definition", operation: "plan", authoringMode: "cli",
  ...
  cap({ id: "infra.remote.ssh", provider: "infrastructure", nativeItemType: "vm", operation: "open-remote", authoringMode: "remote-ssh",
  ...
  // ---- Mongo ----
  cap({ id: "mongo.snapshot.import", provider: "mongo", nativeItemType: "authority-snapshot", operation: "import", authoringMode: "file",
  ...
  cap({ id: "mongo.playground.run", provider: "mongo", nativeItemType: "playground", operation: "run", authoringMode: "mongodb-extension",
  ...
  // ---- Diagrams / apps ----
  cap({ id: "diagram.diagramcloud.export", provider: "diagram", nativeItemType: "architecture-view", operation: "export-projection", authoringMode: "file",
  ...
  cap({ id: "apps.remote-repo.observe", provider: "apps", nativeItemType: "application", operation: "observe-revision", authoringMode: "remote-only",
