...
(commit `7d204f56e876b1d61f5021cc297bcae6dc377cc9`, the head of PR #1, merged into `master` as
`aa8ce9a`; the file blob `d673d4b439e9f5c39a9c3961cfd4678b6a537d49` is unchanged on `master`),
called with **synthetic, non-FOIL input**
