...
|---|---|---|---|---|
| AI-3 | Claude & Codex panel + Codex hand-off (09 §12) | L | Opus 5.5 · high; panel polish medium | Claude Control pass C-1 (linking conversations to orders by the marker, `GET /api/work-orders`) — not built yet in claude-control; without it the panel shows links and Control's existing data only |
