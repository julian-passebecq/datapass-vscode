...
| **0.13.0** | **V3 pass 1: trust fixes, manifest v3 / graph 0.2, repository and file resolution, Project Workbench, Git update loop, AI preparation pack, catalog** | branch `claude/v3-workbench` |
...
1. **Review and merge 0.13.0** (branch `claude/v3-workbench`).
