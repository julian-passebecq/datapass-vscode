...
| **0.17.0** | **V3 pass 5: windows and work views — company workspace file, work views (save/apply), status-bar switcher, `datapass.startupView`, floating Workbench, the Power Ops launcher contract** | **this pass, branch `claude/v017-windows-views`, on 0.16.0** |
...
[v3/07_WINDOWS_AND_POWER_OPS.md](v3/07_WINDOWS_AND_POWER_OPS.md). How an AI prepares a project:
...
3. **PowerToy_UI task** — read the Power Ops launcher list and let its Tool Launcher open a company
