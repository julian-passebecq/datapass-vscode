...
4. Take the next item of `handoff/v3/04_NEXT_PASSES.md` (after 0.13.0: fixes from Julian's acceptance
   report, then Restricted Mode / remote-host desktop qualification).
