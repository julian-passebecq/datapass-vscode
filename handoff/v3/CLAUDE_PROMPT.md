...
4. Take the next item of `handoff/v3/04_NEXT_PASSES.md` (0.16.0 work and DevOps is done; 0.17.0
   windows and work views is in progress in a parallel session — see
   `handoff/v3/06_VISION_AND_READINESS.md`; fixes from Julian's acceptance report come first when
   there is one).
